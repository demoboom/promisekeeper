...
<body>
	...
	<div class="right">
		...
		<legend align="center">登 录 界 面</legend>
			...
			<tr>
				<td class="zi">用户名：<br><input name="uid" type="text" class="input"></td>
			</tr>
			<tr>
				<td class="zi">密  码： <br><input name="upwd" type="password" class="input"></td>
			</tr>
			<tr align="center" height="20px">
				...
				<br>
				<a href="${pageContext.request.contextPath}/toregister" class="size">新用户点此注册</a>
				</td>
			</tr>
			</table>
		</form>
