...
<style type="text/css">
    ...
    .top{height: 20%;width: 100%;padding-left: 180px;padding-top: 20px}
    .ge{font: 36px/1 Tahoma,Helvetica,Arial,"\5b8b\4f53",sans-serif;font-style: italic;}
    .center{height: 80%;width: 100%;padding-left: 150px;margin-top: 10px}
    ...
    .modify{margin-top: 5px;margin-left: 0px;border-radius:12px;font-size: 15px;
        height: 40px;width: 380px;color:black;
        border:none;outline: none
    }
    .modify:hover{box-shadow: 0 12px 16px 0 rgba(0,0,0,0.24), 0 17px 50px 0 rgba(0,0,0,0.19)}
</style>
            ...
            <fieldset>
                ...
                <table cellspacing="25px" width="800px">
                    ...
                    <tr>
                        <td>
                            <label>年 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄：</label>
                            <input name="age" type="number" maxlength="3" value="${user.age}"  class="sr">
                        </td>
                    </tr>
                    <tr>
                        <td>
